...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    title: { en: "Photo, Video & Hotel", vi: "Ảnh, video & khách sạn" },
    vi: "Chụp ảnh, quay phim, khách sạn",
    body: {
      en: "The supporting cast: a photo and video team that knows when to step in and when to disappear, plus hotel-block bookings for out-of-town guests.",
      vi: "Những dịch vụ hỗ trợ: đội chụp ảnh & quay phim biết khi nào tiến tới, khi nào lùi lại, kèm đặt phòng khách sạn cho khách phương xa.",
    },
    bullets: [
      { en: "Photographer + videographer team", vi: "Đội ngũ chụp ảnh & quay phim" },
      { en: "Tea ceremony, áo dài fitting, reception", vi: "Lễ trà, thử áo dài, tiệc cưới" },
