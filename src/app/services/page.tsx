...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    vi: "Áo dài & lễ vấn danh",
    body: {
      en: "The cornerstone of a Vietnamese wedding. Long dress and hat for the groom, lace áo dài and headpiece for the bride, full tray rentals, and the ceremonial wine tray.",
      vi: "Trái tim của đám cưới Việt. Áo dài & khăn đóng cho chú rể, áo dài ren & mấn cho cô dâu, mâm trà & mâm rượu trọn bộ.",
    },
    bullets: [
  ...
  },
  {
    ...
    body: {
      en: "A host who knows when to slow down for an elder's toast, when to translate a joke, and when to step out of the way. Vietnamese, English, and Mandarin Chinese.",
      vi: "MC biết khi nào chậm lại cho lời chúc của người lớn, khi nào dịch câu đùa, khi nào lùi lại. Tiếng Việt, Anh, và Quan Thoại.",
    },
    bullets: [
  ...
  },
  {
    num: "/ 04",
    imgClass: "ph",
    imgLabel: "Catering plates close-up",
    title: { en: "Catering & Cake", vi: "Tiệc & bánh cưới" },
    vi: "Tiệc cưới & bánh kem",
    body: {
      en: "Vietnamese-Canadian menus that work for every guest at the table. Bún chả to braised short rib. Custom multi-tier cake with a fresh-flower topper.",
      vi: "Thực đơn Việt-Canada phù hợp cho mọi khách. Từ bún chả đến bò sốt vang. Bánh kem nhiều tầng trang trí hoa tươi.",
    },
    bullets: [
      { en: "6-, 8-, or 10-course banquet menus", vi: "Thực đơn 6, 8, hoặc 10 món" },
      { en: "Vegetarian & halal options", vi: "Tùy chọn chay & halal" },
      { en: "Custom 3-tier wedding cake", vi: "Bánh cưới 3 tầng theo yêu cầu" },
    ],
    priceLab: { en: "Per head", vi: "Mỗi khách" },
    price: "$95+",
  },
  {
    num: "/ 05",
  ...
  },
  {
    ...
    vi: "Xe, chụp ảnh, khách sạn",
    body: {
      en: "The supporting cast: a chauffeured limo for the wedding party, photo & video coverage, and hotel-block bookings for out-of-town guests.",
      vi: "Những dịch vụ hỗ trợ: limousine có tài xế, chụp ảnh & quay video, đặt khách sạn cho khách phương xa.",
    },
    bullets: [
...
const PACKAGES: Package[] = [
  {
    ...
    bullets: [
      ...
      { en: "Áo dài rental, both", vi: "Cho thuê áo dài (2 bộ)" },
  ...
  },
  {
    ...
    bullets: [
      ...
      { en: "Trilingual MC, full event", vi: "MC ba ngôn ngữ, trọn sự kiện" },
    ],
    cta: { en: "Inquire", vi: "Liên hệ" },
    featured: true,
  },
